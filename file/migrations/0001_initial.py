    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master_lc', models.CharField(blank=True, max_length=128, null=True)),
                ('sales_contact_no', models.CharField(blank=True, max_length=128, null=True)),
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buyersname', to='buyer.buyer')),
            ],
        ),
    ]
