...
urlpatterns = [
    ...
    path('store/<int:work_order>/', StoreBillDetailView.as_view(), name='store_detail'),
    path('store/accessories/<int:work_order>/', StoreAccessoriesDetailView.as_view(), name='store_detail'),
]