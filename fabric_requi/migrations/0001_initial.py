    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uom', models.CharField(choices=[('', 'Select'), ('miter', 'miter'), ('yard', 'yard')], max_length=64, null=True)),
                ...
                ('order_qty', models.IntegerField(blank=True, default=1, null=True)),
                ('cutting_qty', models.IntegerField(blank=True, default=1, null=True)),
                ('cad_consumption', models.CharField(blank=True, max_length=64, null=True)),
                ('requard_qty', models.IntegerField(blank=True, default=1, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='unit_of_fabric_issue', to='unit.unit')),
            ],
        ),
        migrations.CreateModel(
