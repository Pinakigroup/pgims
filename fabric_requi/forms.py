...
class FabricRForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'work_order_fr': ModelSelect2Widget(model=StoreBill, search_fields=['work_order_store__work_order__icontains'], attrs={'style': 'width: 100%', 'data-placeholder': 'Search Work Order No'}),
