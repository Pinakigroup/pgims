    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_by', models.CharField(max_length=64, null=True)),
                ...
                ('file_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='purchase_order.purchasebill')),
