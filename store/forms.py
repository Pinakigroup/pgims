...
class StoreForm(forms.ModelForm):   
    ...
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'work_order_store': ModelSelect2Widget(model=PurchaseBill, search_fields=['work_order__icontains'], attrs={'style': 'width: 100%', 'data-placeholder': 'Search Work Order No'}),
