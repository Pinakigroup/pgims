    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order', models.IntegerField(default=purchase_order.models.generate_random_number)),
                ('sale_contact', models.CharField(blank=True, max_length=64, null=True)),
                ('remarks', models.TextField(blank=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('file_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='file_numbers', to='file.file')),
