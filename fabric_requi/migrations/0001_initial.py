    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_qty', models.FloatField(blank=True, default=0, null=True)),
                ('cutting_qty', models.FloatField(blank=True, default=0, null=True)),
                ('cad_consumption', models.CharField(blank=True, max_length=64, null=True)),
                ('requard_qty', models.FloatField(blank=True, default=0, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
