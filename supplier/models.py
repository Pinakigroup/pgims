...
class Supplier(models.Model):
    ...
    vat_identi_no = models.CharField(max_length=32, blank=True)
    expiry_date = models.DateField(default= now, blank=True) 
    trade_license_no = models.CharField(max_length=32, blank=True)
    ...
    owner_email = models.EmailField(max_length=64, blank=True, unique=True)
    ...
    first_cp_email = models.EmailField(max_length=64, blank=True, unique=True)
    ...
    sec_cp_email = models.EmailField(max_length=64, blank=True, unique=True)
